...
export class OceanScene{
 ...
 this.renderer.domElement.dataset.damage=damage.toFixed(1);this.renderer.domElement.dataset.model=ship.userData.blenderDetail?'blender':'procedural';this.foam.update(s,this.spec,t,strength);const h=s.heave||0;ship.position.set(s.x,h,s.z);ship.rotation.set(s.pitch,-s.heading,-s.roll,'YXZ');
