...
export function restoreTrip(trip,region,spec){
 ...
 return {state:{...createVessel(),...p,sailTarget:trip.sailTarget===1?1:0,sailArea:trip.sailTarget===1?1:0,damage:Number.isFinite(trip.damage)?Math.max(0,Math.min(95,trip.damage)):0,anchored:true},cargo:{bays:[...c.bays],high:!!c.high,ballast:!!c.ballast},mission,completed};
}
